...
func (c *httpResponseWriter) RenderPlainText(
	...
	if err != nil {
		...
		w.WriteHeader(500)
		log.Println(r.Context(), "Response: ", err.Error(), "; StatusCode: ", 500)
		return err
	}
	//log.Println(r.Context(), "Response: ", v.(string), "; StatusCode: ", statusCode)
...
func (c *httpResponseWriter) writeJSON(r *http.Request, w http.ResponseWriter, obj interface{}) error {
	data, err := json.Marshal(obj)
	w.Header().Set("Content-Type", "application/json")

	//log.Println(r.Context(), "Response: ", string(data))
	if err != nil {
		return err
	}
	_, err = w.Write(data)
